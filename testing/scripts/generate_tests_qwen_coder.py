...
# vllm serve "cyankiwi/Qwen3-Coder-30B-A3B-Instruct-AWQ-4bit" --max-model-len 20480
...
MODEL_NAME = "cyankiwi/cyankiwi/Qwen3-Coder-30B-A3B-Instruct-AWQ-4bit"
    ...
    while attempts < MAX_RETRIES:
        ...
        try:
            response = client.chat.completions.create(
                ...
                temperature=0.1 + max(0, attempts - 1) * 0.1,
                top_p=0.85,
                max_tokens=12288,
                timeout=1200,
                extra_body={
